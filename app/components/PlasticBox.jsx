...
const PlasticBox = ({ image, type, count }) => {
    return (
        <div className="group pb-4 bg-blue-200 text-black relative h-fit  m-4 border rounded-lg shadow-md overflow-hidden transition-transform transform-gpu duration-300 hover:scale-105">
